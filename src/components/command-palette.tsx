...
export default function CommandPalette() {
  ...
  const commands = useMemo<Cmd[]>(() => [
    ...
    { id: "help", label: "Help & onboarding", group: "Navigation", icon: Tag, href: "/help" },
    ...
    { id: "recruiter-view", label: "Recruiter View Simulator", hint: "snap verdict + callback odds", group: "AI Tools", icon: Star, href: "/tools/recruiter-view" },
    { id: "quantify", label: "Impact Quantifier", hint: "vague bullet → measurable impact", group: "AI Tools", icon: TrendingUp, href: "/tools/quantify" },
    { id: "recruiter-reply", label: "Recruiter Reply Generator", hint: "polished reply drafts", group: "AI Tools", icon: Mail, href: "/tools/recruiter-reply" },
    { id: "company-prep", label: "Company Interview Prep", hint: "one-page brief in 30s", group: "AI Tools", icon: Briefcase, href: "/tools/company-prep" },
    { id: "tracker", label: "Application Tracker", hint: "kanban for your job hunt", group: "AI Tools", icon: ListTodo, href: "/tools/tracker" },
    { id: "coach", label: "AI Career Coach", hint: "chat with an AI that knows your resume", group: "AI Tools", icon: Bot, href: "/tools/coach" },
